...
#ifndef PROTOBUF_INCLUDED_onnx_2fonnx_2doperators_5fonnx2trt_5fonnx_2dml_2eproto
#define PROTOBUF_INCLUDED_onnx_2fonnx_2doperators_5fonnx2trt_5fonnx_2dml_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_onnx_2fonnx_2doperators_5fonnx2trt_5fonnx_2dml_2eproto ONNX_API
...
class ONNX_API FunctionProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:onnx2trt_onnx.FunctionProto) */ {
 public:
  FunctionProto();
 ...
 private:
  ...
  int status_;
  friend struct ::protobuf_onnx_2fonnx_2doperators_5fonnx2trt_5fonnx_2dml_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class ONNX_API OperatorProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:onnx2trt_onnx.OperatorProto) */ {
 public:
  OperatorProto();
...
class ONNX_API OperatorSetProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:onnx2trt_onnx.OperatorSetProto) */ {
 public:
  OperatorSetProto();
 ...
 private:
  ...
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::onnx2trt_onnx::OperatorProto > operator__;
  ::google::protobuf::RepeatedPtrField< ::onnx2trt_onnx::FunctionProto > functions_;
...
inline ::onnx2trt_onnx::OperatorSetIdProto* FunctionProto::mutable_opset_import(int index) {
  // @@protoc_insertion_point(field_mutable:onnx2trt_onnx.FunctionProto.opset_import)
...
FunctionProto::mutable_opset_import() {
  // @@protoc_insertion_point(field_mutable_list:onnx2trt_onnx.FunctionProto.opset_import)
  return &opset_import_;
}
inline const ::onnx2trt_onnx::OperatorSetIdProto& FunctionProto::opset_import(int index) const {
  // @@protoc_insertion_point(field_get:onnx2trt_onnx.FunctionProto.opset_import)
  return opset_import_.Get(index);
}
inline ::onnx2trt_onnx::OperatorSetIdProto* FunctionProto::add_opset_import() {
  // @@protoc_insertion_point(field_add:onnx2trt_onnx.FunctionProto.opset_import)
...
FunctionProto::opset_import() const {
  // @@protoc_insertion_point(field_list:onnx2trt_onnx.FunctionProto.opset_import)
  return opset_import_;
}
...
inline ::google::protobuf::RepeatedPtrField< ::onnx2trt_onnx::OperatorProto >*
...
inline const ::google::protobuf::RepeatedPtrField< ::onnx2trt_onnx::OperatorProto >&
...
inline ::google::protobuf::RepeatedPtrField< ::onnx2trt_onnx::FunctionProto >*
...
inline const ::google::protobuf::RepeatedPtrField< ::onnx2trt_onnx::FunctionProto >&
...
#endif  // PROTOBUF_INCLUDED_onnx_2fonnx_2doperators_5fonnx2trt_5fonnx_2dml_2eproto
