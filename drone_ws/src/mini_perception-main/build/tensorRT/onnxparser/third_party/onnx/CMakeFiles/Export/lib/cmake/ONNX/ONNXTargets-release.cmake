...
set_target_properties(onnx PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libonnx.so"
  IMPORTED_SONAME_RELEASE "libonnx.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS onnx )
list(APPEND _IMPORT_CHECK_FILES_FOR_onnx "${_IMPORT_PREFIX}/lib/libonnx.so" )
...
set_target_properties(onnx_proto PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libonnx_proto.so"
  IMPORTED_SONAME_RELEASE "libonnx_proto.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS onnx_proto )
list(APPEND _IMPORT_CHECK_FILES_FOR_onnx_proto "${_IMPORT_PREFIX}/lib/libonnx_proto.so" )
