...
#ifndef GOOGLE_PROTOBUF_INCLUDED_onnx_2fonnx_2ddata_5fonnx2trt_5fonnx_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_onnx_2fonnx_2ddata_5fonnx2trt_5fonnx_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_onnx_2fonnx_2ddata_5fonnx2trt_5fonnx_2eproto ONNX_API
...
struct ONNX_API TableStruct_onnx_2fonnx_2ddata_5fonnx2trt_5fonnx_2eproto {
...
extern ONNX_API const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_onnx_2fonnx_2ddata_5fonnx2trt_5fonnx_2eproto;
...
class ONNX_API SequenceProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:onnx2trt_onnx.SequenceProto) */ {
 public:
  SequenceProto();
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "onnx2trt_onnx.SequenceProto";
  }
  private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_onnx_2fonnx_2ddata_5fonnx2trt_5fonnx_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  private:
  const ::onnx2trt_onnx::TensorProto& _internal_tensor_values(int index) const;
  ::onnx2trt_onnx::TensorProto* _internal_add_tensor_values();
  public:
  ...
  private:
  const ::onnx2trt_onnx::SparseTensorProto& _internal_sparse_tensor_values(int index) const;
  ::onnx2trt_onnx::SparseTensorProto* _internal_add_sparse_tensor_values();
  public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx2trt_onnx::SequenceProto >*
      mutable_sequence_values();
  private:
  const ::onnx2trt_onnx::SequenceProto& _internal_sequence_values(int index) const;
  ::onnx2trt_onnx::SequenceProto* _internal_add_sequence_values();
  public:
  const ::onnx2trt_onnx::SequenceProto& sequence_values(int index) const;
  ::onnx2trt_onnx::SequenceProto* add_sequence_values();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx2trt_onnx::SequenceProto >&
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx2trt_onnx::MapProto >*
      mutable_map_values();
  private:
  const ::onnx2trt_onnx::MapProto& _internal_map_values(int index) const;
  ::onnx2trt_onnx::MapProto* _internal_add_map_values();
  public:
  const ::onnx2trt_onnx::MapProto& map_values(int index) const;
  ::onnx2trt_onnx::MapProto* add_map_values();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx2trt_onnx::MapProto >&
      map_values() const;
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx2trt_onnx::TensorProto > tensor_values_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx2trt_onnx::SparseTensorProto > sparse_tensor_values_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx2trt_onnx::SequenceProto > sequence_values_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx2trt_onnx::MapProto > map_values_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr name_;
  ::PROTOBUF_NAMESPACE_ID::int32 elem_type_;
  friend struct ::TableStruct_onnx_2fonnx_2ddata_5fonnx2trt_5fonnx_2eproto;
};
// -------------------------------------------------------------------

class ONNX_API MapProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:onnx2trt_onnx.MapProto) */ {
 public:
  MapProto();
  virtual ~MapProto();
  ...
  ::onnx2trt_onnx::SequenceProto* _internal_mutable_values();
  public:
...
inline const ::onnx2trt_onnx::TensorProto& SequenceProto::_internal_tensor_values(int index) const {
...
inline ::onnx2trt_onnx::TensorProto* SequenceProto::_internal_add_tensor_values() {
...
inline const ::onnx2trt_onnx::SparseTensorProto& SequenceProto::_internal_sparse_tensor_values(int index) const {
...
inline ::onnx2trt_onnx::SparseTensorProto* SequenceProto::_internal_add_sparse_tensor_values() {
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx2trt_onnx::SequenceProto >*
...
inline const ::onnx2trt_onnx::SequenceProto& SequenceProto::_internal_sequence_values(int index) const {
...
inline ::onnx2trt_onnx::SequenceProto* SequenceProto::_internal_add_sequence_values() {
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx2trt_onnx::SequenceProto >&
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx2trt_onnx::MapProto >*
SequenceProto::mutable_map_values() {
  // @@protoc_insertion_point(field_mutable_list:onnx2trt_onnx.SequenceProto.map_values)
  return &map_values_;
}
inline const ::onnx2trt_onnx::MapProto& SequenceProto::_internal_map_values(int index) const {
...
inline ::onnx2trt_onnx::MapProto* SequenceProto::_internal_add_map_values() {
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx2trt_onnx::MapProto >&
...
inline const ::onnx2trt_onnx::SequenceProto& MapProto::_internal_values() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::onnx2trt_onnx::SequenceProto*>(
...
inline ::onnx2trt_onnx::SequenceProto* MapProto::_internal_mutable_values() {
  _has_bits_[0] |= 0x00000002u;
  if (values_ == nullptr) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_onnx_2fonnx_2ddata_5fonnx2trt_5fonnx_2eproto
