...
inline const ::onnx2trt_onnx::OperatorSetIdProto& FunctionProto::_internal_opset_import(int index) const {
...
inline ::onnx2trt_onnx::OperatorSetIdProto* FunctionProto::_internal_add_opset_import() {
