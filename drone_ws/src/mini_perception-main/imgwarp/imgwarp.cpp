...
void StereoWarpper::Init(const cv::Mat &Kl, const cv::Mat &Dl, const cv::Mat &Rl, const cv::Mat &Pl,
  ...
  cv::initUndistortRectifyMap(Kl, Dl, Rl, Pl, cv::Size(wl, hl), CV_16SC2, rmap_[0][0], rmap_[0][1]);
  cv::initUndistortRectifyMap(Kr, Dr, Rr, Pr, cv::Size(wr, hr), CV_16SC2, rmap_[1][0], rmap_[1][1]);
